...
public class Berlin_cultural_life_info implements Cultural_life_info {
    ...
    public Berlin_cultural_life_info() {
    }

    public Berlin_cultural_life_info(int id, String title, String description) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        Berlin_cultural_life_info that = (Berlin_cultural_life_info) o;
