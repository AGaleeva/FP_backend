...
@Entity
@Table(name = "berlin_restaurants_info")
public class BerlinRestaurantsInfo implements Restaurants_info {
    ...
    public BerlinRestaurantsInfo() {
    }

    public BerlinRestaurantsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        BerlinRestaurantsInfo that = (BerlinRestaurantsInfo) o;
    ...
    public String toString() {
        return ("BerlinRestaurantsInfo: id = %d, title = %s, description = %s, address = %s," +
