...
public class BerlinCulturalLifeInfo implements Cultural_life_info {
    ...
    public BerlinCulturalLifeInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public String toString() {
        return ("BerlinCulturalLifeInfo: id = %d, title = %s, description = %s, address = %s," +
