...
@Entity
@Table(name = "berlin_shops_info")
public class BerlinShopsInfo implements Shops_info {
    ...
    public BerlinShopsInfo() {
    }

    public BerlinShopsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        BerlinShopsInfo that = (BerlinShopsInfo) o;
    ...
    public String toString() {
        return ("BerlinShopsInfo: id = %d, title = %s, description = %s, address = %s," +
