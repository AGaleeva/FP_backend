...
@Entity
@Table(name = "hamburg_restaurants_info")
public class HamburgRestaurantsInfo implements Restaurants_info {
    ...
    public HamburgRestaurantsInfo() {
    }

    public HamburgRestaurantsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        HamburgRestaurantsInfo that = (HamburgRestaurantsInfo) o;
    ...
    public String toString() {
        return ("HamburgRestaurantsInfo: id = %d, title = %s, description = %s, address = %s," +
