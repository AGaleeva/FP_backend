...
@Entity
@Table(name = "hamburg_children_info")
public class HamburgChildrenInfo implements Children_info {
    ...
    public HamburgChildrenInfo() {
    }

    public HamburgChildrenInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        HamburgChildrenInfo that = (HamburgChildrenInfo) o;
    ...
    public String toString() {
        return ("HamburgChildrenInfo: id = %d, title = %s, description = %s, address = %s," +
