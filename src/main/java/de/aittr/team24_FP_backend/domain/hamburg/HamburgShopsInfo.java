...
@Entity
@Table(name = "hamburg_shops_info")
public class HamburgShopsInfo implements Shops_info {
    ...
    public HamburgShopsInfo() {
    }

    public HamburgShopsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        HamburgShopsInfo that = (HamburgShopsInfo) o;
    ...
    public String toString() {
        return ("HamburgShopsInfo: id = %d, title = %s, description = %s, address = %s," +
