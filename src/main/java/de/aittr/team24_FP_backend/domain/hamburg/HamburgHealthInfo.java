...
public class HamburgHealthInfo implements Health_info {
    ...
    public HamburgHealthInfo() {
    }

    public HamburgHealthInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        HamburgHealthInfo that = (HamburgHealthInfo) o;
    ...
    public String toString() {
        return ("HamburgHealthInfo: id = %d, title = %s, description = %s, address = %s," +
