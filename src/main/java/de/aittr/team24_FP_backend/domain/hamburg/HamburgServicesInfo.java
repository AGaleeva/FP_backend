...
public class HamburgServicesInfo implements Services_info {
    ...
    public HamburgServicesInfo() {
    }

    public HamburgServicesInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        HamburgServicesInfo that = (HamburgServicesInfo) o;
    ...
    public String toString() {
        return ("HamburgServicesInfo: id = %d, title = %s, description = %s, address = %s," +
