...
@Entity
@Table(name = "hamburg_cultural_life_info")
public class HamburgCulturalLifeInfo implements Cultural_life_info {
    ...
    public HamburgCulturalLifeInfo() {
    }

    public HamburgCulturalLifeInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        HamburgCulturalLifeInfo that = (HamburgCulturalLifeInfo) o;
    ...
    public String toString() {
        return ("HamburgCulturalLifeInfo: id = %d, title = %s, description = %s, address = %s," +
