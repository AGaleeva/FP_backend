...
@Entity
@Table(name = "frankfurt_shops_info")
public class FrankfurtShopsInfo implements Shops_info {
    ...
    public FrankfurtShopsInfo() {
    }

    public FrankfurtShopsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        FrankfurtShopsInfo that = (FrankfurtShopsInfo) o;
    ...
    public String toString() {
        return ("FrankfurtShopsInfo: id = %d, title = %s, description = %s, address = %s," +
