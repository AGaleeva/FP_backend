...
@Entity
@Table(name = "frankfurt_children_info")
public class FrankfurtChildrenInfo implements Children_info {
    ...
    public FrankfurtChildrenInfo() {
    }

    public FrankfurtChildrenInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        FrankfurtChildrenInfo that = (FrankfurtChildrenInfo) o;
    ...
    public String toString() {
        return ("FrankfurtChildrenInfo: id = %d, title = %s, description = %s, address = %s," +
