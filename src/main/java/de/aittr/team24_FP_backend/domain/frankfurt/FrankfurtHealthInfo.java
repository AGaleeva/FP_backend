...
@Entity
@Table(name = "frankfurt_health_info")
public class FrankfurtHealthInfo implements Health_info {
    ...
    public FrankfurtHealthInfo() {
    }

    public FrankfurtHealthInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        FrankfurtHealthInfo that = (FrankfurtHealthInfo) o;
    ...
    public String toString() {
        return ("FrankfurtHealthInfo: id = %d, title = %s, description = %s, address = %s," +
