...
@Entity
@Table(name = "frankfurt_cultural_life_info")
public class FrankfurtCulturalLifeInfo implements Cultural_life_info {
    ...
    public FrankfurtCulturalLifeInfo() {
    }

    public FrankfurtCulturalLifeInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        FrankfurtCulturalLifeInfo that = (FrankfurtCulturalLifeInfo) o;
    ...
    public String toString() {
        return ("FrankfurtCulturalLifeInfo: id = %d, title = %s, description = %s, address = %s," +
