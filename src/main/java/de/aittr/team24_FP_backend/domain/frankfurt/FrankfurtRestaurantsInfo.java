...
@Entity
@Table(name = "frankfurt_restaurants_info")
public class FrankfurtRestaurantsInfo implements Restaurants_info {
    ...
    public FrankfurtRestaurantsInfo() {
    }

    public FrankfurtRestaurantsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        FrankfurtRestaurantsInfo that = (FrankfurtRestaurantsInfo) o;
    ...
    public String toString() {
        return ("FrankfurtRestaurantsInfo: id = %d, title = %s, description = %s, address = %s," +
