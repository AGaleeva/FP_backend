...
public class Frankfurt_services_info implements General_news {
    ...
    public Frankfurt_services_info() {
    }

    public Frankfurt_services_info(int id, String title, String description) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        Frankfurt_services_info that = (Frankfurt_services_info) o;
