...
public class FrankfurtServicesInfo implements Services_info {
    ...
    public FrankfurtServicesInfo() {
    }

    public FrankfurtServicesInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        FrankfurtServicesInfo that = (FrankfurtServicesInfo) o;
    ...
    public String toString() {
        return ("FrankfurtServicesInfo: id = %d, title = %s, description = %s, address = %s," +
