...
public class MunchenRestaurantsInfo implements Restaurants_info {
    ...
    public MunchenRestaurantsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public String toString() {
        return ("MunchenRestaurantsInfo: id = %d, title = %s, description = %s, address = %s," +
