...
@Entity
@Table(name = "munchen_cultural_life_info")
public class MunchenCulturalLifeInfo implements Cultural_life_info {
    ...
    public MunchenCulturalLifeInfo() {
    }

    public MunchenCulturalLifeInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MunchenCulturalLifeInfo that = (MunchenCulturalLifeInfo) o;
    ...
    public String toString() {
        return ("MunchenCulturalLifeInfo: id = %d, title = %s, description = %s, address = %s," +
