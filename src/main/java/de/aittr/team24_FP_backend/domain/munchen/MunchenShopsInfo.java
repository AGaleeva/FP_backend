...
@Entity
@Table(name = "munchen_shops_info")
public class MunchenShopsInfo implements Shops_info {
    ...
    public MunchenShopsInfo() {
    }

    public MunchenShopsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MunchenShopsInfo that = (MunchenShopsInfo) o;
    ...
    public String toString() {
        return ("MunchenShopsInfo: id = %d, title = %s, description = %s, address = %s," +
