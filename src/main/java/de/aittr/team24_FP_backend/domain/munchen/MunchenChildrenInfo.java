...
public class MunchenChildrenInfo implements Children_info {
    ...
    public MunchenChildrenInfo() {
    }

    public MunchenChildrenInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MunchenChildrenInfo that = (MunchenChildrenInfo) o;
    ...
    public String toString() {
        return ("MunchenChildrenInfo: id = %d, title = %s, description = %s, address = %s," +
