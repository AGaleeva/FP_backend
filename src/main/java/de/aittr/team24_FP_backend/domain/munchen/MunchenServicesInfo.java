...
public class MunchenServicesInfo implements Services_info {
    ...
    public MunchenServicesInfo() {
    }

    public MunchenServicesInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MunchenServicesInfo that = (MunchenServicesInfo) o;
    ...
    public String toString() {
        return ("MunchenServicesInfo: id = %d, title = %s, description = %s, address = %s," +
