...
@Entity
@Table(name = "munchen_health_info")
public class MunchenHealthInfo implements Health_info {
    ...
    public MunchenHealthInfo() {
    }

    public MunchenHealthInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MunchenHealthInfo that = (MunchenHealthInfo) o;
    ...
    public String toString() {
        return ("MunchenHealthInfo: id = %d, title = %s, description = %s, address = %s," +
