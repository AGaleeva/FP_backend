...
public class MunchenNews implements General_news {
    ...
    public MunchenNews(int id, String title, String description) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        MunchenNews that = (MunchenNews) o;
    ...
    public String toString() {
        return "MunchenNews: id = %d, title = %s, description = %s".formatted(id, title, description);
    }
}
