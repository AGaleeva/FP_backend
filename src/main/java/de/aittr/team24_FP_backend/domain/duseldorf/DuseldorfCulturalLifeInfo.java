...
public class DuseldorfCulturalLifeInfo implements Cultural_life_info {
    ...
    public DuseldorfCulturalLifeInfo() {
    }

    public DuseldorfCulturalLifeInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        DuseldorfCulturalLifeInfo that = (DuseldorfCulturalLifeInfo) o;
    ...
    public String toString() {
        return ("DuseldorfCulturalLifeInfo: id = %d, title = %s, description = %s, address = %s," +
