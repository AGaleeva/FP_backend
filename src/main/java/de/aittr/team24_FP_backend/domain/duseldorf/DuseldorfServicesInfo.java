...
@Entity
@Table(name = "duseldorf_services_info")
public class DuseldorfServicesInfo implements Services_info {
    ...
    public DuseldorfServicesInfo() {
    }

    public DuseldorfServicesInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        DuseldorfServicesInfo that = (DuseldorfServicesInfo) o;
    ...
    public String toString() {
        return ("DuseldorfServicesInfo: id = %d, title = %s, description = %s, address = %s," +
