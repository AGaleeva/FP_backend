...
@Entity
@Table(name = "duseldorf_shops_info")
public class DuseldorfShopsInfo implements Shops_info {
    ...
    public DuseldorfShopsInfo() {
    }

    public DuseldorfShopsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        DuseldorfShopsInfo that = (DuseldorfShopsInfo) o;
    ...
    public String toString() {
        return ("DuseldorfShopsInfo: id = %d, title = %s, description = %s, address = %s," +
