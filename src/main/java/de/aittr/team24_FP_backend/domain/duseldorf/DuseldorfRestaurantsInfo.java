...
public class DuseldorfRestaurantsInfo implements Restaurants_info {
    ...
    public DuseldorfRestaurantsInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public String toString() {
        return ("DuseldorfRestaurantsInfo: id = %d, title = %s, description = %s, address = %s," +
