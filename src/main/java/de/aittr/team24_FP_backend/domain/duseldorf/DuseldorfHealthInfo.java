...
@Entity
@Table(name = "duseldorf_health_info")
public class DuseldorfHealthInfo implements Health_info {
    ...
    public DuseldorfHealthInfo() {
    }

    public DuseldorfHealthInfo(Integer id, String title, String description, String address, String tel, String link, Integer status) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        DuseldorfHealthInfo that = (DuseldorfHealthInfo) o;
    ...
    public String toString() {
        return ("DuseldorfHealthInfo: id = %d, title = %s, description = %s, address = %s," +
