...
public class Duseldorf_news implements General_news {
    ...
    public Duseldorf_news() {
    }

    public Duseldorf_news(int id, String title, String description) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        Duseldorf_news that = (Duseldorf_news) o;
