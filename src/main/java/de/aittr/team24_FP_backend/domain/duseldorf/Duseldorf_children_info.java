...
public class Duseldorf_children_info implements Children_info {
    ...
    public Duseldorf_children_info() {
    }

    public Duseldorf_children_info(int id, String title, String description) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        Duseldorf_children_info that = (Duseldorf_children_info) o;
    ...
    public String toString() {
        return "Duseldorf children info: id = %d, title = %s, description = %s".formatted(id, title, description);
    }
}
